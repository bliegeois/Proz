...
local
   ListOfPersons = {ProjectLib.loadDatabase file "/Users/Benjamin/Desktop/Proz/database.txt"}
   ...
   in
      case Tree
      of leaf(nil) then Result = {ProjectLib.found ['No players found']}
      [] leaf(R) then Result = {ProjectLib.found R}
